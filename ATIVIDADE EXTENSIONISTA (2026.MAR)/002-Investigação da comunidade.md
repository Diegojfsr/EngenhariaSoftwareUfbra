...
![](https://desenvolvimento-extensao.dreamshaper.com/uploads/richtext/images/20241212195338675b3f42ee9a7.png)

Nesta etapa, será realizado o processo de investigação de uma comunidade, com o objetivo de compreender suas características e necessidades. O trabalho inicia-se a partir da escolha dos Objetivos de Desenvolvimento Sustentável (ODS) 6 e 7 e da relação entre eles, para o estudo em 2026.1, por parte da instituição de ensino. De sua parte, a definição da comunidade de interesse e a escolha de métodos de pesquisa para a coleta de informações. Essa etapa estabelece as bases para a análise e o planejamento nas próximas fases.
#### Objetivos de aprendizagem

- Entender a relação entre os ODS 6 e 7, para que possa escolher uma comunidade, em que seja viável o estudo e a aplicação prática para viabilizar o alcance e/ou minimizar o impacto do não atendimento dos ODS objetos de estudo de 2026.1;
- Compreender o processo de identificação e análise de uma comunidade, a partir da escolha dos ODS 6 e 7 e sua relação, considerando suas características e necessidades;
- Definir métodos de pesquisa adequados para coletar informações relevantes sobre a comunidade;
- Reconhecer a importância de fundamentar escolhas com base em dados e evidências coletadas.

## Definição do tema

![](https://desenvolvimento-extensao.dreamshaper.com/uploads/richtext/images/20241212200000675b40c08c6a0.png)

Na etapa anterior, foram apresentados os Objetivos de Desenvolvimento Sustentável (ODS), que orientam ações para enfrentar desafios globais e promover uma sociedade mais justa e sustentável. Agora, é o momento de você estudar um pouco mais sobre os ODS 6 e 7 e compreender a relação entre eles, visto que servirão como base para o tema da atividade de extensão a ser desenvolvida.

A escolha deve refletir um tema relevante, capaz de direcionar as ações extensionistas e conectar o aprendizado acadêmico às demandas reais da comunidade que será investigada. Essa etapa é essencial para alinhar o projeto aos objetivos de impacto social e transformação.

#### Objetivos de Desenvolvimento 6 e 7

#### ODS 6: Água Potável e Saneamento
O ODS 6 trata da garantia de água potável e saneamento para todas as pessoas. Ele busca assegurar que a população tenha acesso a água de qualidade, livre de contaminação e disponível de forma segura. Também envolve ampliar o tratamento e a coleta de esgoto, reduzindo a poluição dos rios e protegendo os recursos hídricos. Outro ponto importante é promover o uso sustentável da água, evitando desperdícios e incentivando práticas de conservação. O ODS 6 ainda destaca a necessidade de proteger ecossistemas aquáticos, como nascentes e aquiíferos, essenciais para o equilíbrio ambiental. Ao cumprir esse objetivo, fortalece-se a saúde pública, a qualidade de vida e o desenvolvimento sustentável das comunidades.

#### ODS 7: Energia Limpa e Acessível
O ODS 7 busca garantir que todas as pessoas tenham acesso a energia limpa, segura e a um custo acessível. Ele incentiva a expansão de fontes renováveis, como solar, eólica e biomassa, reduzindo a dependência de combustíveis fósseis e diminuindo os impactos ambientais. Também envolve melhorar a eficiência energética, promovendo tecnologias e práticas que consumam menos energia sem perder desempenho. Outro aspecto importante é ampliar a infraestrutura energética, especialmente em regiões onde o acesso ainda é limitado ou instável. O ODS 7 destaca ainda a necessidade de inovação e investimento para tornar a energia sustentável mais disponível e competitiva. Ao avançar nesta objetivo, fortalece-se o desenvolvimento econômico, a qualidade de vida e a proteção do planeta.


#### Relação entre os ODS 6 e 7
A integração entre o ODS 6 e o ODS 7 se dá porque a água potável e o saneamento depende de sistemas energéticos confiáveis, enquanto a expansão de energias renováveis fortalece a sustentabilidade dos serviços de água. Quando esses dois objetivos são trabalhados juntos, é possível melhorar a infraestrutura comunitária, reduzir custos e ampliar a autonomia das populações, especialmente em regiões vulneráveis. essa relação cria um ciclo positivo: energia limpa torna o abastecimento de água mais eficiente e o uso responsável da água reduz a demanda energética.
Além disso, integrar esses ODS favorece práticas educativas e tecnológicas que fortalecem a participação comunitária. A população passa a compreender como o uso consciente da água e da energia está conectado ao bem-estar coletivo, à preservação ambiental e ao desenvolvimento local. Assim, a integração entre os ODS 6 e 7 promove soluções sustentáveis que ampliam direitos básicos, estimulam a inovação e fortalecem a resiliência das comunidades.

Em um projeto de extensão que integre os ODS 6 e 7, podemos trabalhar em comunidades para promover a gestão sustentável da água e a adoção de energias renováveis. Isso pode incluir atividades como:

Promover a educação e a conscientização sobre o uso responsável da água e da energia;
Incentivar práticas de eficiência energética e redução de desperdícios;
Desenvolver programas de capacitação sobre tecnologias de energia solar e sistemas de tratamento de água;
Trabalhar com comunidades para identificar desafios locais relacionados à água e energia e construtir soluões sustentáveis de forma participativa.

Considere os ODS 6 e 7 como base para o projeto e explique como você planeja abordar essas interconexões em seu projeto, destacando as oportunidades e desafios que essa abordagem pode trazer.

#### ✅ Resposta ao Desafio

Para estruturar meu projeto de extensão integrando os ODS 6 (Água Potável e Saneamento) e ODS 7 (Energia Limpa e Acessível), irei destacar como essas metas se conectam de forma prática e transformadora na comunidade. 

1.Abordagem Integrada
Gestão sustentável da água: Propor ações de conscientização sobre uso racional da água, coleta seletiva de resíduos líquidos e incentivo ao reaproveitamento de águas pluviais.
Educação ambiental: Incentivar atividades educativas que mostrem como o consumo consciente de água e energia está diretamente ligado à saúde, economia e preservação ambiental.

2.Oportunidades
Autonomia comunitária: Incentivar a redução e a dependência de sistemas externos, fortalecendo a resiliência local.
Inovação social: Estimular a criação de soluções criativas e sustentáveis que podem ser replicadas em outras comunidades.
Saúde pública: Melhorar a qualidade de vida ao reduzir doenças relacionadas à falta de saneamento e ao uso de combustíveis poluentes.

3.Desafios
Infraestrutura limitada: Falta de recursos básicos para implementar tecnologias de água e energia.
Financiamento sustentável: Recursos financeiros para manter os projetos a longo prazo.
Engajamento comunitário: Mobilização da população para participar ativamente e compreender a importância das mudanças.
Adaptação tecnológica: Ajustar soluções às realidades locais, evitando propostas que não sejam viáveis cultural ou economicamente.

4.Caminho para o Projeto
Diagnóstico participativo: Ouvir a comunidade sobre suas necessidades de água e energia.
Educação e capacitação: Oficinas práticas e campanhas educativas.
Implementação piloto: Instalação de técnicas simples e acessíveis.
Monitoramento e expansão: Avaliar resultados para assim ampliar o alcance.

5.Possíveis Temas
Educação comunitária sobre água e energia: Oficinas e campanhas educativas mostrando como o consumo consciente de água e energia fortalece a saúde e reduz custos familiares.
Eficiência energética em sistemas de abastecimento: Modernização de bombas e sistemas de distribuição de água para reduzir consumo energético e desperdício hídrico.
Comunidades resilientes: Projetos participativos que unem gestão da água e acesso à energia limpa, fortalecendo a autonomia e a capacidade de resposta a crises climáticas.


Resumo para envio:

Para estruturar meu projeto de extensão integrando os ODS 6 (Água Potável e Saneamento) e ODS 7 (Energia Limpa e Acessível), irei destacar como essas metas se conectam de forma prática e transformadora na comunidade. 
1.Abordagem Integrada: Propor ações de conscientização sobre uso racional da água, coleta seletiva de resíduos líquidos e incentivo ao reaproveitamento de águas pluviais.
2.Oportunidades: Estimular a criação de soluções criativas e sustentáveis que podem ser replicadas em outras comunidades.
3.Desafios: Falta de recursos básicos para implementar tecnologias de água e energia.
4.Caminho para o Projeto: Ouvir a comunidade sobre suas necessidades de água e energia, oficinas práticas e campanhas educativas, instalação de técnicas simples e acessíveis e avaliar resultados para assim ampliar o alcance.


## Identificação da comunidade

![](https://desenvolvimento-extensao.dreamshaper.com/uploads/richtext/images/20241212201758675b44f66c09d.png)

Após selecionar os Objetivos de Desenvolvimento Sustentável (ODS) como base para o projeto extensionista, é fundamental estabelecer uma conexão com a comunidade onde as ações serão realizadas. No contexto da extensão universitária, a comunidade vai além de um espaço geográfico; ela pode ser definida como um grupo de pessoas que compartilham interesses, valores, problemas ou necessidades. Essa identificação permite uma abordagem mais assertiva e alinhada às demandas sociais.
Uma comunidade pode estar unida por:

- Interesses comuns, como a valorização de práticas culturais ou esportivas.
- Valores compartilhados, como princípios religiosos, ambientais ou sociais.
- Problemas específicos, como falta de saneamento, desigualdades educacionais ou insegurança alimentar.
- Necessidades e desafios, que demandam soluções práticas e inclusivas.

#### Local da atividade
Indique abaixo o nome da comunidade (entidade) onde você irá realizar a atividade, que será conferido mais adiante para garantir a correspondência com o endereço informado:

#### Endereço
Indique abaixo o endereço completo do local, que deverá ser comprovado por geolocalização e verificado se corresponde à entidade citada, na fase da execução:

#### Público-alvo
Qual público-alvo será o foco do projeto?

Quais aspectos ou características tornam esse público-alvo relevante para os ODS escolhidos?

#### ✅ Resposta ao Desafio


- Localização
Bairro Ramos, Zona Norte do Rio de Janeiro.
CEP: 21031-700.
Perfil urbano: Área residencial com cerca de 680 endereços, incluindo casas, apartamentos e vilas. 
Serviços próximos: escolas municipais, creches, centro de saúde, igrejas e espaços esportivos. 

Desafios relacionados ao ODS 6 (Água Potável e Saneamento):
Histórico de problemas de esgoto: moradores relataram dificuldades crônicas com saneamento, apenas parcialmente resolvidas por intervenções recentes. 
Infraestrutura precária: buracos e obras inacabadas da concessionária Águas do Rio ainda causam transtornos. 
Espaços públicos degradados: praças e áreas de lazer apresentam riscos devido à falta de manutenção, impactando diretamente a qualidade de vida. 

Rua João Romariz, localizada em Ramos na Zona Norte do Rio de Janeiro, apresenta características que a tornam um potencial local para desenvolver um projeto integrado dos ODS 6 e 7, pois enfrenta desafios de saneamento básico e infraestrutura urbana, além de contar com serviços comunitários próximos que podem apoiar ações de extensão. 



- Público-alvo sugerido
Moradores locais – famílias que enfrentam problemas de saneamento básico e custos elevados de energia.
Estudantes e escolas da região – jovens que podem ser multiplicadores de práticas sustentáveis e participar de oficinas educativas.
Associação de moradores – entidade que organiza demandas coletivas e pode apoiar a mobilização comunitária.
Trabalhadores informais e pequenos comerciantes – grupos que podem se beneficiar de soluções de eficiência energética e redução de custos.
Lideranças comunitárias e religiosas – atores sociais que ajudam a engajar e sensibilizar a população.
...
Após identificar a comunidade de interesse, é hora de selecionar os métodos de pesquisa para coletar dados e compreender suas necessidades e desafios. Cada método oferece perspectivas únicas, e sua combinação pode proporcionar uma visão mais completa da realidade da comunidade. O documentário fotográfico, obrigatório nesta etapa, será essencial para registrar visualmente o contexto e enriquecer a análise, complementando os demais métodos disponíveis.


#### Observação Participante
Esse método envolve a imersão direta no contexto da comunidade, onde o pesquisador não apenas observa, mas também participa ativamente das atividades cotidianas. Isso proporciona uma visão mais próxima das dinâmicas sociais, culturais e econômicas, permitindo entender melhor o ambiente e as interações locais.

#### Pesquisa
A pesquisa envolve a coleta de dados por meio de fontes variadas, como documentos, registros e outros materiais que ajudem a contextualizar a comunidade. A pesquisa pode incluir a análise de documentos (como relatórios, políticas públicas e dados estatísticos) e o levantamento de dados qualitativos e quantitativos, com o objetivo de entender os aspectos mais amplos que impactam a comunidade.

#### Entrevistas
As entrevistas podem ser realizadas de forma individual ou coletiva. As entrevistas individuais permitem uma compreensão mais profunda das experiências e percepções de uma pessoa, enquanto os grupos focais e/ou discussões (entrevistas coletivas) são úteis para captar diferentes pontos de vista dentro de um grupo. Ambos os tipos de entrevista fornecem informações valiosas sobre as necessidades e perspectivas da comunidade.

#### Questionário
O questionário é um método estruturado que coleta dados por meio de perguntas específicas, podendo ser aplicado a um grande número de pessoas. Ele é útil para obter informações quantitativas e qualitativas, ajudando a identificar padrões e tendências nas respostas da comunidade.

#### Diário de Campo
Um método em que o pesquisador registra reflexões, observações e insights obtidos durante as interações com a comunidade. Esse registro contínuo auxilia na documentação detalhada do processo investigativo, permitindo capturar nuances que podem ser esquecidas em outros métodos.


#### Escolha dos métodos de pesquisa
Escolha 1 ou mais métodos que serão utilizados para obter informações sobre a comunidade.
Observação Participante
Pesquisa
Entrevista e/ou Discussão
Questionário
Diário de campo


De que forma esses métodos podem subsidiar a compreensão das demandas e potencialidades da comunidade?

#### ✅ Resposta ao Desafio

Ao optar por Observação Participante e Diário de Campo, garanto uma abordagem profunda e contextualizada para compreender a comunidade.

Observação Participante
Permite imersão direta no cotidiano da comunidade, identificando práticas relacionadas ao uso da água e energia.
Ajuda a perceber potencialidades invisíveis, como lideranças comunitárias, iniciativas informais de sustentabilidade e redes de solidariedade.

Diário de Campo
Funciona como um registro contínuo de reflexões e percepções, capturando nuances que podem ser esquecidas em outros métodos.
